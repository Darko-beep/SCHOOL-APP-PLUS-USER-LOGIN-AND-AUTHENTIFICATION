...
app.get('/api/v1/admin/:id', (req, res) => {
  try {
    ...
    res.status(200).json({ 
        status: 'success', 
        data: `Fetched admin with ID ${req.params.id}` });
  } catch (error) {
    res.status(500).json({ status: 'fail', error: error.message });
  }
});
...
app.put('/api/v1/admin/:id', (req, res) => {
  try {
    ...
    res.status(200).json({ 
        status: 'success', 
        data: `Updated admin with ID ${req.params.id}` });
  } catch (error) {
    res.status(500).json({ status: 'fail', error: error.message });
  }
});
...
app.delete('/api/v1/admin/:id', (req, res) => {
  try {
    ...
    res.status(200).json({ 
        status: 'success', 
        data: `Deleted admin with ID ${req.params.id}` });
  } catch (error) {
    res.status(500).json({ status: 'fail', error: error.message });
  }
});
...
app.put('/api/v1/admin/suspend/teacher/:id', (req, res) => {
  try {
    ...
    res.status(200).json({ 
        status: 'success', 
        data: `Suspended teacher with ID ${req.params.id}` });
  } catch (error) {
    res.status(500).json({ status: 'fail', error: error.message });
  }
});
...
app.put('/api/v1/admin/unsuspend/teacher/:id', (req, res) => {
  try {
    ...
    res.status(200).json({ 
        status: 'success', 
        data: `Unsuspended teacher with ID ${req.params.id}` });
  } catch (error) {
    res.status(500).json({ status: 'fail', error: error.message });
  }
});
...
app.put('/api/v1/admin/withdraw/teacher/:id', (req, res) => {
  try {
    ...
    res.status(200).json({ 
        status: 'success', 
        data: `Withdrew teacher with ID ${req.params.id}` });
  } catch (error) {
    res.status(500).json({ status: 'fail', error: error.message });
  }
});
...
app.put('/api/v1/admin/unwithdraw/teacher/:id', (req, res) => {
  try {
    ...
    res.status(200).json({ 
        status: 'success', 
        data: `Unwithdrew teacher with ID ${req.params.id}` });
  } catch (error) {
    res.status(500).json({ status: 'fail', error: error.message });
  }
});
...
app.put('/api/v1/admin/publish/exam/:id', (req, res) => {
  try {
    ...
    res.status(200).json({ 
        status: 'success', 
        data: `Published exam results for ID ${req.params.id}` });
  } catch (error) {
    res.status(500).json({ status: 'fail', error: error.message });
  }
});
...
app.put('/api/v1/admin/unpublish/exam/:id', (req, res) => {
  try {
    ...
    res.status(200).json({ 
        status: 'success', 
        data: `Unpublished exam results for ID ${req.params.id}` });
  } catch (error) {
    res.status(500).json({ status: 'fail', error: error.message });
  }
});
